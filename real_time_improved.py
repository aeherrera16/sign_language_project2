...
==============================================================
Sistema avanzado con métricas de confianza, suavizado de predicciones y evaluación en tiempo real
"""
...
class SignLanguageRealTime:
    def __init__(self):
        ...
        self.prediction_buffer = deque(maxlen=10)  # Buffer más grande
    ...
    def predecir_gesto(self, landmarks):
        """Realizar predicción con métricas mejoradas"""
        try:
            # Realizar predicción
            ...
            # Filtro de confianza
            if confianza < 0.7:  # Umbral más alto
    ...
    def obtener_prediccion_suavizada(self):
        """Obtener predicción suavizada usando votación ponderada"""
    ...
    def dibujar_info(self, image, gesto_actual, confianza, fps):
        """Dibujar información mejorada en pantalla"""
        h, w = image.shape[:2]
        ...
        if gesto_actual:
            ...
            cv2.putText(image, "Sin detección confiable", (20, y_offset), 
        ...
        try:
            while True:
                ...
                if landmarks is not None:
                    ...
                    # Hablar si es una nueva predicción confiable
            ...
            print(f"   📈 Precisión promedio: {(self.confident_predictions/self.total_predictions*100):.1f}%" if self.total_predictions > 0 else "   📈 Sin predicciones")
...
def main():
    ...
    print("   Sistema Mejorado con Métricas Avanzadas")
    print("=" * 60)
