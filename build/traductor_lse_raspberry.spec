# traductor_lse_raspberry.spec - PyInstaller para Raspberry Pi (ARM64 Linux)
# Se ejecuta DENTRO de un contenedor ARM64 en CI.
import sys
import os
...
# =====================================================================
# MediaPipe: recopilar TODO el paquete
# =====================================================================
...
a = Analysis(
    ...
    hiddenimports=mp_hiddenimports + [
        'utils_silenciar',
        'pyttsx3.drivers',
        'pyttsx3.drivers.espeak',   # Linux usa espeak (no sapi5)
...
exe = EXE(
    ...
    debug=False,
    strip=True,
    upx=False,      # UPX no es confiable en ARM
    console=True,   # Linux: consola visible para debug
)
