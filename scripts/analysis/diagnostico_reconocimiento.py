...
"""
🔧 DIAGNOSTICO DEL SISTEMA DE RECONOCIMIENTO
===========================================
Script para diagnosticar problemas de reconocimiento de senas
"""
...
def verificar_modelo():
    ...
    if not modelo_encontrado:
        print("\n🚨 ERROR CRITICO: No se encontro ningun modelo (.h5)")
        print(" SOLUCION: Ejecuta 'python train_model.py' primero")
        return False
    
    if not labels_encontradas:
        print("\n🚨 ERROR CRITICO: No se encontraron las etiquetas")
        print(" SOLUCION: Verifica que existan labels.pkl o labels.txt")
        return False
...
def verificar_camara():
    """Verificar que la camara funciona"""
    print("\n🎥 VERIFICANDO CAMARA...")
    print("=" * 50)
    ...
    if not cap.isOpened():
        ...
        print(" SOLUCIONES:")
        print("   1. Verifica que la camara este conectada")
        print("   2. Cierra otras aplicaciones que usen la camara")
    ...
    print(f" Camara disponible: {width}x{height} @ {fps}FPS")
    ...
    try:
        ...
        if os.path.exists('test_camera.jpg'):
            ...
            if results_face.multi_face_landmarks:
                ...
                print("⚠️ No se detecto cara en la imagen de prueba")
...
def verificar_landmarks():
    """Verificar extraccion de landmarks"""
    print("\n📐 VERIFICANDO EXTRACCION DE LANDMARKS...")
    print("=" * 50)
    
    try:
        from utils import extraer_landmarks
        print(" Funcion extraer_landmarks importada")
        ...
        print(f" Landmarks extraidos: {len(landmarks)} caracteristicas")
...
def test_reconocimiento_completo():
    ...
    print(" Haz una sena frente a la camara")
    ...
    try:
        ...
        while True:
            ...
            cv2.imshow('Diagnostico LSE', frame)
        ...
        if detecciones == 0:
            ...
            print(" SOLUCIONES:")
            print("   1. Asegurate de tener buena iluminacion")
            print("   2. Manten las manos visibles en el centro")
            print("   3. Fondo contrastante (no del color de tu piel)")
            
        elif predicciones == 0:
            print("\n🚨 PROBLEMA: Se detectaron manos pero no hay predicciones")
            print(" SOLUCIONES:")
            print("   1. Verifica que el modelo este entrenado")
            print("   2. Haz gestos mas claros y definidos")
            print("   3. Manten la sena por mas tiempo")
...
def main():
    ...
    print("🔧 DIAGNOSTICO DEL SISTEMA LSE ECUADOR")
    print("=" * 60)
    print("Este script verificara todos los componentes del sistema")
    print("=" * 60)
