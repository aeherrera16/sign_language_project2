...
def extract_hand_landmarks(results):
    ...
    - Centra los puntos en la muñeca (landmark 0).
...
def extraer_landmarks(results_hands, results_face):
    ...
    Args:
        results_hands: Resultados de detección de manos de MediaPipe
        results_face: Resultados de detección facial de MediaPipe
